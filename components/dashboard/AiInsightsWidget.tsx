...
export default function AiInsightsWidget() {
    ...
    if (isLoading) {
        return (
            <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl shadow-lg p-6 text-white h-full relative overflow-hidden">
    ...
    return (
        <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl shadow-lg p-6 text-white h-full relative overflow-hidden group">
